package ink.breakpoint.easypay.user.service;
...
import ink.breakpoint.easypay.user.api.ResourceService;
import ink.breakpoint.easypay.user.api.dto.authorization.AuthorizationInfoDTO;
...
import ink.breakpoint.easypay.user.api.dto.resource.ResourceDTO;
import ink.breakpoint.easypay.user.convert.ResourceApplicationConvert;
import ink.breakpoint.easypay.user.entity.ResourceApplication;
import ink.breakpoint.easypay.user.entity.ResourceButton;
import ink.breakpoint.easypay.user.entity.ResourceMenu;
import ink.breakpoint.easypay.user.mapper.ResourceApplicationMapper;
import ink.breakpoint.easypay.user.mapper.ResourceButtonMapper;
import ink.breakpoint.easypay.user.mapper.ResourceMenuMapper;
