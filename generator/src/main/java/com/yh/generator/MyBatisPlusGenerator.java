...
public class MyBatisPlusGenerator {
    ...
    public static void main(String[] args) {
        ...
        //当前项目名
        String projectName = "/easypay-common";

        globalConfig.setOutputDir(projectPath + projectName+"/src/main/java");
        globalConfig.setAuthor("XXcoder");
		...
		// 商户服务
//		dataSourceConfig
//				.setUrl("jdbc:mysql://218.29.75.103:6306/huiminpay_merchant_service?serverTimezone=Asia/Shanghai");

		// 交易服务
		dataSourceConfig
				.setUrl("jdbc:mysql://127.0.0.1:3306/easypay_merchant_service?serverTimezone=Asia/Shanghai&useSSL=false");
        ...
        packageConfig.setParent("ink.breakpoint.easypay");
        //如果需要手动输入模块名
